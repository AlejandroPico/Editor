...
describe('geometría vectorial', () => {
  ...
  it('genera rutas SVG válidas para conexiones', () => {
    ...
    const base = { title:'',subtitle:'',visibleValue:'',width:100,height:60,rotation:0,shape:'rounded' as const,fill:'#fff',stroke:'#000',strokeWidth:1,opacity:1,layerId,type:'entity',status:'active',summary:'',details:{},tags:[] };
    const source={...base,id:'a',x:0,y:0},target={...base,id:'b',x:300,y:200};
    const edge={id:'e',sourceId:'a',targetId:'b',label:'',kind:'connection',route:'orthogonal' as const,directed:true,color:'#000',colors:[],width:2,dash:'',opacity:1,waypoints:[],layerId};
